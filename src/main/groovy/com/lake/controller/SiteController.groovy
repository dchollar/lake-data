...
class SiteController {
    ...
    Collection<SiteDto> getAll() {
        ...
        auditService.audit(HttpMethod.GET, '/api/sites', this.class.simpleName, true)
    ...
    Collection<LocationDto> getSiteLocations(@PathVariable(name = 'siteId', required = true) Integer siteId) {
        ...
        auditService.audit(HttpMethod.GET, "/public/api/sites/${siteId}/locations", this.class.simpleName)
    ...
    Collection<UnitDto> getSiteUnits(@PathVariable(name = 'siteId', required = true) Integer siteId) {
        ...
        auditService.audit(HttpMethod.GET, "/public/api/sites/${siteId}/units", this.class.simpleName)
