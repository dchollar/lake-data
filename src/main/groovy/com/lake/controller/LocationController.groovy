...
class LocationController {
    ...
    Collection<LocationDto> getAll() {
        ...
        auditService.audit(HttpMethod.GET, '/api/locations', this.class.simpleName, true)
    ...
    LocationDto create(@RequestBody LocationDto dto) {
        ...
        auditService.audit(HttpMethod.POST, '/api/locations', this.class.simpleName, true)
    ...
    LocationDto update(@PathVariable(name = 'locationId', required = true) Integer locationId,
        ...
        auditService.audit(HttpMethod.PUT, "/api/locations/${locationId}", this.class.simpleName, true)
    ...
    void delete(@PathVariable(name = 'locationId', required = true) Integer locationId) {
        ...
        auditService.audit(HttpMethod.DELETE, "/api/locations/${locationId}", this.class.simpleName, true)
